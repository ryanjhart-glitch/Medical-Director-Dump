...
async function fetchPDLCandidates() {
  ...
  const EXCLUDE = `AND job_title NOT LIKE '%technician%'
    ...
    AND job_title NOT LIKE '%hospital manager%'
    AND job_title NOT LIKE '%hospital administrator%'
    AND job_title NOT LIKE '%practice manager%'
    AND job_title NOT LIKE '%office manager%'
    AND job_title NOT LIKE '%kennel%'
    AND job_title NOT LIKE '%professor%'
